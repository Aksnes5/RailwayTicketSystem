    ...
    private fun installAll() {
        ...
        val lanxinRoute = RailwayRoute(
            ...
            stations = listOf(
                ...
                Station("民和南", "Minhe South", "MHJ"),
                Station("海东", "Haidong", "HDJ"),
                Station("西宁", "Xining", "XNO"),
                Station("大通西", "Datong West", "DTO"),
                Station("门源", "Menyuan", "MYO"),
                Station("山丹马场", "Shandan Horse Ranch", "SDO"),
                Station("民乐", "Minle", "MLJ"),
        ...
        val guigangRoute = RailwayRoute(
            ...
            stations = listOf(
                ...
                Station("阳朔", "Yangshuo", "YSZ"),
                Station("恭城", "Gongcheng", "GCZ"),
                Station("钟山西", "Zhongshan West", "ZSZ"),
                Station("贺州", "Hezhou", "HZZ"),
                Station("怀集", "Huaiji", "HJQ"),
                Station("广宁", "Guangning", "GNQ"),
                Station("肇庆东", "Zhaoqing East", "ZQQ"),
                Station("三水南", "Sanshui South", "SSQ"),
                Station("佛山西", "Foshan West", "FSQ"),
