...
object NationalPassengerRailCatalog {
    ...
    private fun highSpeedEntries(): List<Entry> = listOf(
        ...
        h("NPR_FUXIA", "福厦高铁", 103.0, "55分钟", "福州", "福州南", "福清西", "莆田", "泉州东", "泉州南", "厦门北"),
        h("NPR_JINWEN", "金温铁路", 126.0, "1小时35分钟", "金华", "武义北", "永康南", "缙云西", "丽水", "青田", "温州南"),
        c("NPR_JINTAI", "金台铁路", 105.0, "1小时30分钟", "金华", "横店", "磐安", "仙居", "临海", "台州"),
        c("NPR_QUNING", "衢宁铁路", 138.0, "2小时15分钟", "衢州", "龙游", "遂昌", "松阳", "庆元", "屏南", "周宁", "宁德"),
        ...
        i("NPR_WUXIAO", "武孝城际铁路", 42.0, "30分钟", "汉口", "后湖", "金银潭", "天河机场", "天河街", "闵集", "毛陈", "槐荫", "孝感东"),
