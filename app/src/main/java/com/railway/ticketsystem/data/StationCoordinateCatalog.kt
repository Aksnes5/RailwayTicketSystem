...
object StationCoordinateCatalog {
    private val exactStations = mapOf(
        ...
        "厦门" to point(118.087, 24.469), "厦门北" to point(117.999, 24.638), "莆田" to point(119.057059, 25.353868), "仙游" to point(118.866665, 25.253513), "泉州" to point(118.563241, 24.975946), "晋江" to point(118.454145, 24.797407),
        ...
        "后湖" to point(114.269, 30.640), "金银潭" to point(114.259, 30.662),
        "天河机场" to point(114.211, 30.773), "天河街" to point(114.207, 30.824),
        "闵集" to point(114.136, 30.826), "毛陈" to point(113.986, 30.866),
        "槐荫" to point(113.960, 30.899), "孝感东" to point(113.942, 30.936),
        "云梦东" to point(113.779, 31.048), "安陆西" to point(113.647, 31.256),
        "随州南" to point(113.357, 31.653), "随县" to point(113.204, 31.768),
        "枣阳" to point(112.756, 32.072), "隆中" to point(111.989, 31.969),
        "谷城北" to point(111.625, 32.308), "丹江口南" to point(111.516, 32.550),
        "武当山西" to point(111.009, 32.540),
        ...
        // 昌福铁路：不要退回城市中心或同名地名。尤其“永泰”必须指向福建永泰站，
        // 否则建宁县北以后会被绘制成跨省的错误长线段。
        "抚州" to point(116.347298, 27.922141), "南城" to point(116.611058, 27.567130),
        "南丰" to point(116.597375, 27.289408), "建宁县北" to point(116.866219, 26.919124),
        "泰宁" to point(117.148299, 26.930724), "将乐" to point(117.473131, 26.698410),
        "三明北" to point(117.801804, 26.378896), "尤溪" to point(118.136757, 26.170218),
        "永泰" to point(118.929064, 25.851529),
