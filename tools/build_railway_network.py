...
NATIONAL_CORRIDOR_ALIASES = {
    ...
    "京唐城际铁路": ["京唐"], "津兴城际铁路": ["津兴"], "大张高铁": ["大张", "张大客专"],
    ...
    "菏兖日铁路": ["菏兖日", "新兖线", "兖石线", "兖石铁路"], "石德铁路": ["石德线"], "邯长铁路": ["邯长线"],
    "太焦铁路": ["太焦线"], "侯月铁路": ["侯月线"], "宁西铁路": ["宁西线"],
    "皖赣铁路": ["皖赣线"], "宣杭铁路": ["宣杭线"], "鹰厦铁路": ["鹰厦线"],
    "漳龙铁路": ["漳龙线"], "赣龙铁路": ["赣龙线"], "合九铁路": ["合九线"],
    "青阜铁路": ["青阜线", "青阜铁路"], "洛湛铁路": ["洛湛线", "焦柳线", "益湛铁路", "黎湛线", "黎湛铁路"], "益湛铁路": ["益湛线", "益湛铁路"],
